...
Route::middleware(['auth','seller'])->prefix('seller')->as('seller.')->group(function() {
    ...
    Route::post('/sku-status', 'ProductController@updateSkuStatusByID')->name('product.sku.status')->middleware(['prohibited_demo_mode']);
    ...
    Route::get('/product/{id}/clone','ProductController@myProductClone')->name('my-product.clone');
