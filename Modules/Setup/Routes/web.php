...
Route::middleware(['auth','admin'])->prefix('generalsetting')->group(function() {
    //analytics tool
    Route::get('/analytics', 'AnalyticsToolController@index')->name('setup.analytics.index')->middleware(['permission','prohibited_demo_mode']);
    Route::get('/google-maps-api', 'GoogleMapsApiController@index')->name('setup.maps.index')->middleware(['permission','prohibited_demo_mode']);
