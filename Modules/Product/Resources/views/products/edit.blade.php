                                ...
                                <div class="white_box_50px box_shadow_white mb-20 pt-0 p-15">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><strong>{{__('common.type') }}</strong>@if($product->product_type == 2) ({{__('product.variant_product_is_not_changable_to_single_product')}}) @elseif($product->product_type == 1 && !product_attribute_editable($product->id)) ({{__('product.change_not_possible_for_use')}}) @endif<span class="text-danger">*</span></label>
                                                ...
                                                @foreach ($product->variations->unique('attribute_id') as $key => $choice_option)
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="primary_input mb-25">
                                                                <input class="primary_input_field" width="40%" name="choice[]" type="text" value="{{ \Modules\Product\Entities\Attribute::find($choice_option->attribute_id)->name }}" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-7">
                                                            <div class="primary_input mb-25">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        ...
                                                        <input class="primary_input_field" name="additional_shipping" placeholder="{{__('product.additional_shipping_charge') }}" type="number" min="0" step="{{step_decimal()}}" value="{{ @$product->skus->first()->additional_shipping }}">
                                                ...
                                                <div class="QA_table mb_15">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table create_table">
                                                            ...
                                                            <tr>
                                                                <td>{{__('wholesale.Min QTY')}}</td>
                                                                <td>{{__('wholesale.Max QTY')}}</td>
                                                            ...
                                                            @foreach($wholesale_price as $w_key=>$w_sale_price)
                                                                <tr class="whole_sale_price_list whole_sale_price_list_child">
                                                                    <td class="pl-0 pb-0 pr-3 border-0">
                                                                        <input type="text" class="form-control primary_input_field" name="wholesale_min_qty_0[]" value="{{ $w_sale_price->min_qty }}">
                                                                    </td>
                                                                    <td class="pl-0 pb-0 pr-3 border-0">
                                                                        <input type="text" class="form-control primary_input_field" name="wholesale_max_qty_0[]" value="{{ $w_sale_price->max_qty }}">
                                                                    </td>
                                                                    <td class="pl-0 pb-0 pr-3 border-0">
                                                                        <input type="text" class="form-control primary_input_field" name="wholesale_price_0[]" value="{{ $w_sale_price->selling_price }}">
                                                                    </td>
                                    ...
                                    @else
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label" for="meta_title"> {{ __('common.meta_title') }}</label>
                                                <input class="primary_input_field" id="meta_title" name="meta_title" placeholder="{{ __('common.meta_title') }}" type="text" value="{{ $product->meta_title }}">
                                                <span class="text-danger">{{ $errors->first('meta_title') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                    ...
                                    @endif
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="">{{__('product.meta_image') }} ({{getNumberTranslate(300)}} X {{getNumberTranslate(300)}}){{__('common.px')}}</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" id="video_link" name="video_link" placeholder="{{ __('product.video_link') }}" type="text" value="{{ $product->video_link }}">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                    ...
                                                    <li>
                                                        <label data-id="color_option" class="primary_checkbox d-flex mr-12">
                                                            <input name="display_in_details" value="2" id="status_inactive" @if ($product->display_in_details == 2) checked @endif class="de_active" type="radio">
                                                            <span class="checkmark"></span>
                                                        </label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                    <li>
                                                        <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                                            <input name="auto_update_required" id="auto_update_required_active" value="1" {{$product->auto_update?'checked':''}} class="active" type="radio">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        <p>{{ __('common.on') }}</p>
                                                    </li>
                                                    <li>
                                                        <label data-id="color_option" class="primary_checkbox d-flex mr-12">
                                                            <input name="auto_update_required" value="0" id="auto_update_required_inactive" {{!$product->auto_update?'checked':''}} class="de_active" type="radio">
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        <p>{{ __('common.off') }}</p>
                                                    </li>
