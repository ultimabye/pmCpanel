                        ...
                        <div class="col-lg-8">
                            <div class="white_box pt-0 box_shadow_white mb-20 p-15">
                                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 sku_single_div d-none" id="default_lang_{{$language->code}}">
                                                                <div class="primary_input mb-15">
                                                                    ...
                                                                    <input class="primary_input_field" name="product_sku[{{$language->code}}]" id="sku_single" placeholder="{{ __('product.product_sku') }}" type="text" value="{{old('product_sku.'.$language->code)}}">
                                    ...
                                    <div class="col-lg-12 sku_combination overflow-auto"></div>
                                    <div class="col-xl-12">
                                        <div class="primary_input">
                                            <ul id="theme_nav" class="permission_list sms_list ">
                                                <li>
                                    ...
                                    <div class="col-lg-12  weight_height_div">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-lg-3">
                                               <div class="primary_input mb-15">
                                                   <label class="primary_input_label" for="breadth"> {{ __('product.breadth')}} [{{__('product.cm')}}]</label>
                                           ...
                                           <div class="col-lg-3">
                                               <div class="primary_input mb-15">
                                                   <label class="primary_input_label" for="height"> {{ __('product.height')}} [{{__('product.cm')}}]</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 selling_price_div">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input class="primary_input_field selling_price" name="selling_price" id="selling_price" placeholder="{{ __('product.selling_price') }}" type="number" min="1" step="{{step_decimal()}}" value="{{old('selling_price')?old('selling_price'):''}}">
                                        ...
                                        <div class="tab-content">
                                            @foreach ($LanguageList as $key => $language)
                                                <div role="tabpanel" class="tab-pane fade pelement @if (auth()->user()->lang_code == $language->code) show active @endif" id="pelement{{$language->code}}">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                            <textarea class="summernote2" id="specification" name="specification[{{$language->code}}]"> {{old('specification.'.$language->code)}}</textarea>
                                                        </div>
                                                    </div>
