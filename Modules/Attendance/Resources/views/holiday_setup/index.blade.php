                                                                            ...
                                                                            <div class="col">
                                                                                <div class="">
                                                                                    <input placeholder="{{ __('common.date') }}"
                                                                                           class="primary_input_field primary-input date form-control"
                                                                                           type="text" name="date[]"
                                                                                           value="{{dateConvert($data['date'][$key])}}"
                                                                                           autocomplete="off">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col">
                                                                                <div class="">
                                                                                    <input placeholder="{{ __('common.date') }}"
                                                                                           ...
                                                                                           type="text"
                                                                                           name="start_date[]"
                                                                                           value="{{dateConvert($data['start_date'][$key])}}"
                                                                                           autocomplete="off">
                                                                                </div>
                                                                            </div>
                                                                            <button class="" type="button">
                                                                            ...
                                                                            <div class="col">
                                                                                <div class="">
                                                                                    <input placeholder="{{ __('common.date') }}"
                                                                                           ...
                                                                                           value="{{dateConvert($data['end_date'][$key])}}"
                                                                                           autocomplete="off">
                                                                                </div>
                                                                            </div>
                                                                            <button class="" type="button">
                                                                            ...
                                                                            <div class="col">
                                                                                <div class="">
                                                                                    <input placeholder="{{ __('common.date') }}"
                                                                                           class="primary_input_field primary-input date form-control"
                                                                                           type="text" name="date[]"
                                                                                           value="{{dateConvert($holiday->date) }}"
                                                                                           autocomplete="off">
                                                                                </div>
                                                                            </div>
                                                                            <button class="" type="button">
                                                                            ...
                                                                            <div class="col">
                                                                                <div class="">
                                                                                    <input placeholder="{{ __('common.date') }}"
                                                                                           ...
                                                                                           type="text"
                                                                                           name="start_date[]"
                                                                                           value="{{dateConvert(!empty($date) ? date('m/d/Y',strtotime($date[0]))  : date('m/d/y'))}}"
                                                                                           autocomplete="off">
                                                                                </div>
                                                                            </div>
                                                                            <button class="" type="button">
                                                                            ...
                                                                            <div class="col">
                                                                                <div class="">
                                                                                    <input placeholder="{{ __('common.date') }}"
                                                                                           class="primary_input_field primary-input date form-control"
                                                                                           type="text" name="end_date[]"
                                                                                           value="{{dateConvert(!empty($date) ? date('m/d/Y',strtotime($date[1])) : date('m/d/y'))}}"
                                                                                           autocomplete="off">
                                                                                </div>
                                                                            </div>
                                                                            <button class="" type="button">
