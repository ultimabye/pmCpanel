                        ...
                        <div class="add-visitor">
                            <div class="row">
                                <div class="col-lg-8" id="lg-toggle-8">
                                                ...
                                                <ul id="theme_nav" class="permission_list sms_list">
                                                    <li>
                                                        <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                                            <input name="product_type" id="redeem_card" value="1"
                                                                @if (!old('product_type') || old('product_type') == 1) checked @endif
                                                    ...
                                                    <li>
                                                        <label data-id="color_option" class="primary_checkbox d-flex mr-12">
                                                            <input name="product_type" value="2" id="gift_card_prod"
                                                                @if (old('product_type') && old('product_type') == 2) checked @endif
                                    ...
                                    <div class="row" id="redeem_card_row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="primary_input mb-25">
                                                ...
                                                @error('selling_price')
                                                    <span class="text-danger"
                                                        id="error_selling_price">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input mb-25">
                                                ...
                                                @error('shipping_id')
                                                    <span class="text-danger" id="error_shipping">{{ $message 
                                                    }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input mb-15">
                                                ...
                                                @error('date')
                                                    <span class="text-danger" id="error_date">{{ $message }}
                                                    </span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="row d-none" id="gift_card">
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field" type="text" id="gift_name"
                                                    ...
                                                    placeholder="{{ __('common.name') }}">
                                                @error('gift_name')
                                                    <span class="text-danger" id="error_gift_name">{{ $message 
                                                    }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4" id="lg-toggle-4">
                                    <div class="row" id="redem_card_row">
                                    ...
                                    <div class="row d-none mt-5 pt-4" id="giftt_card_row">
                                        <div class="col-lg-12">
                                            <div class="row mb-25">
                                                <div class="col-lg-8">
                                                    <div class="primary_input">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                @error('status')
                                                    <span class="text-danger" id="status_error_gift">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                            ...
                            <div class="row mt-40">
                                <div class="col-lg-6 offset-lg-3">
                                    <div class="col-lg-12 text-center">
                                        <button id="submit_btn" type="submit" class="primary-btn fix-gr-bg" data-toggle="tooltip">
