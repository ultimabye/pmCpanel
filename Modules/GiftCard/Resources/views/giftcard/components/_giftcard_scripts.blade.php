            ...
            function cardDataTable(){
                $('#digitalcardTable').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'thumbnail_image_one', name: 'thumbnail_image_one' },
                        { data: 'gift_card_value', name: 'gift_card_value' },
                        { data: 'gift_selling_price', name: 'gift_selling_price' },
                        { data: 'number_of_gift_card', name: 'number_of_gift_card' },
                        { data: 'gift_selling_coupon', name: 'gift_selling_coupon' },
                        { data: 'status', name: 'status' },
                        { data: 'action_td', name: 'action' }
