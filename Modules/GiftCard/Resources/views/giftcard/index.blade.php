                ...
                <div class="box_header_right">
                    <div class="float-lg-right float-none pos_tab_btn justify-content-end">
                        <ul class="nav nav_list" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active show" href="#order_processing_data" role="tab" data-toggle="tab" id="gift_card" aria-selected="true">{{ __('product.redeem_card') }} {{__('common.list')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#digitalgiftcard" role="tab" data-toggle="tab" id="digital_gift_card" aria-selected="true">{{ __('common.gift_card') }} {{__('common.list')}}</a>
                            </li>
                            @endif
                        </ul>
                    </div>
