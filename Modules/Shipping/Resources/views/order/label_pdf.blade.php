...
<div class="invoice_wrapper">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="line_grid" >
                                                <span>
                                                    <span>{{__('shipping.deliver_to')}}</span>
                                                </span>
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="line_grid" >
                                                ...
                                                {{($order->order->customer_id) ? $order->order->billing_address->getCity->name : $order->order->guest_info->getCity->name}}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="line_grid" >
                                                ...
                                                {{($order->order->customer_id) ? $order->order->billing_address->getState->name : $order->order->guest_info->getState->name}}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="line_grid" >
                                                ...
                                                {{($order->order->customer_id) ? $order->order->billing_address->getCountry->name : $order->order->guest_info->getCountry->name}}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="line_grid" >
                                                ...
                                                {{($order->order->customer_id) ? $order->order->billing_address->postal_code : $order->order->guest_info->postal_code}}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="text-align: right;" class="line_grid2" >
                                                <span>
                                                    <span>{{__('shipping.shipped_by')}}</span>
                                                </span>
                                            </p>
                                        </td>
                                    </tr>
    ...
    <table class="table border_table mb_30" >
        ...
        <tbody>
            ...
            @endphp
            <tr>
                <td colspan="3" class="">{{__('order.sub_total')}}</td>
                <td class="text_right">{{single_price($sub_total)}}</td>
            </tr>
            <tr>
                <td colspan="3" class="">{{__('common.tax')}}/{{__('common.shipping')}}/{{__('common.others')}}/{{__('common.coupon')}}</td>
                <td class="text_right">{{single_price($others)}}</td>
            </tr>
            <tr>
                <td colspan="3" class="">{{__('order.total')}}</td>
    ...
    <table>
        <tbody>
        <tr>
            <td>{{__('pos.invoice_no')}}: {{getNumberTranslate($order->order->order_number)}} | {{__('order.invoice_date')}}: {{dateConvert(showDate($order->created_at))}}</td>
        </tr>
        @php
