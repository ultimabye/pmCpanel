...
class ExpenseDataTable extends DataTable
{
    ...
    {
        return $model->where('type', 'out')->whereIn('come_from', ['sales_income','income','expense','sales_expense','wallet_recharge','payroll_expense','installment_income','loan_expense','seller_commision','refund_seller_commis'])->newQuery();
    }
