<?php
    return [    
        ...
        'pricing_is_required' => 'Pricing is required',
        ...
        'Custom JS' => 'Custom JS',
        'Without style tag' => 'Without style tag',
        'Without script tag' => 'Without script tag',
        'default' => 'Default',
        'color_scheme_one' => 'Color Scheme One',
        'color_scheme_two' => 'Color Scheme Two',
        'color_scheme_three' => 'Color Scheme Three',
        'color_scheme_four' => 'Color Scheme Four',
        'color_scheme_five' => 'Color Scheme Five',
    ]
?>