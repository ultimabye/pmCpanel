                ...
                <div class="shiping_address_box checkout_form m-0">
                    ...
                    <div class="billing_address">
                        ...
                        <div class="row shipping_address_edit_div {{$shipping_address?'d-none':""}}">
                            ...
                            <div class="col-lg-6 mb_20">
                                <label class="primary_label2 style3">{{__('common.country')}} @if($checkoutField[3]->required==1) <span>*</span> @endif </label>
                            ...
                            <div class="col-lg-6 mb_20">
                                <label class="primary_label2 style3">{{__('common.state')}} @if($checkoutField[2]->required==1) <span>*</span> @endif </label>
                            ...
                            <div class="col-lg-6 mb_20">
                                <label class="primary_label2 style3">{{__('common.city')}} @if($checkoutField[1]->required==1)<span>*</span> @endif </label>
