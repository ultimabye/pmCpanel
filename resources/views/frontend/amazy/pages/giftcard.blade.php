...
<div class="brand_banner d-flex align-items-center">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h3 class="branding_text">{{ __('common.reedem_card') }}</h3>
            </div>
        </div>
    </div>
</div>
        ...
        (function($){
            ...
            $(document).ready(function(){
                ...
                $(document).on('click', ".add_to_cart_gift_thumnail", function() {
                    addToCart($(this).attr('data-gift-card-id'),$(this).attr('data-seller'),1,$(this).attr('data-base-price'),1,'gift_card',$(this).data('prod_info'), $(this).data('gift-card-type'));
                });
