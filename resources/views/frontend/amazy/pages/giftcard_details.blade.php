                    ...
                    <div class="col-lg-6 col-xl-6">
                        <div class="product_content_details mb_20">
                            ...
                            <div class="destils_prise_information_box mb_20">
                                ...
                                @if(@$card->hasDiscount())
                                    <div class="pro_details_disPrise d-flex align-items-center gap_15">
                                        <h4 class="discount_prise  m-0  "> <span class="text-decoration-line-through"> {{single_price($card->sell_price)}}</span> </h4>
                            ...
                            <div class="product_info">
                                ...
                                @php
                                    if($card->hasDiscount()){
                                        $base_price = selling_price($card->sell_price, $card->discount_type, $card->discount);
                                    }else{
                                        $base_price = $card->sell_price;
                                    }
                                    $showData = [
                                        'name' => $card->name,
