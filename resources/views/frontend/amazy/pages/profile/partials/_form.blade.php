                        ...
                        <form action="#">
                            <div class="row">
                                ...
                                <div class="col-12 mb_25">
                                    ...
                                    {{-- <textarea name="address" id="address" placeholder="{{__('common.Street Address')}}" onfocus="this.placeholder = ''" onblur="this.placeholder = '{{__('common.Street Address')}}'" class="primary_textarea4 radius_5px mb_25">{{isset($primary_address->address_one)?$primary_address->address:''}}</textarea> --}}
