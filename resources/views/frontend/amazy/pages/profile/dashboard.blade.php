                                                    ...
                                                    <td>
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            @if(isModuleActive('MultiVendor'))
                                                                <p class="font_14 f_w_600 mb-1 lh-base">{{__('common.package')}}: {{getNumberTranslate(@$order->package_code)}}</p>
                                                            @endif
                                            ...
                                            @if($product->type == 'product')
                                                <a href="{{singleProductURL(@$product->product->seller->slug, @$product->product->slug)}}" class="dashboard_order_list d-flex align-items-center flex-wrap  gap_20">
                                                    ...
                                                    <div class="dashboard_order_content">
                                                        <h4 class="font_14 f_w_700 mb-1 lh-base theme_hover">@if (@$product->product->product_name) {{ \Illuminate\Support\Str::limit(@$product->product->product_name, 28, $end='...') }}  @else {{ \Illuminate\Support\Str::limit(@$product->product->product->product_name, 28, $end='...') }} @endif</h4>
