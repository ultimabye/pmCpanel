                                ...
                                <div class="d-flex align-items-center gap_20 flex-wrap gray_color_1 dashboard_orderDetails_head  justify-content-between theme_border">
                                    <div class="d-flex flex-column  ">
                                        <div class="d-flex align-items-center flex-wrap gap_5">
                                            <h4 class="font_14 f_w_500 m-0 lh-base">{{__('common.order_id')}}: </h4> <p class="font_14 f_w_400 m-0 lh-base">{{ getNumberTranslate($refund_request->order->order_number) }}</p>
                                        </div>
                                        <div class="d-flex align-items-center flex-wrap gap_5">
                                            <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.order_date')}} :  </h4> <p class="font_14 f_w_400 m-0 lh-base">{{ getNumberTranslate($refund_request->order->created_at->format('d-m-Y h:i:s A')) }}</p>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column ">
                                        <div class="d-flex align-items-center flex-wrap gap_5">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap_5">
                                            <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.request_sent_date')}}:   </h4> <p class="font_14 f_w_400 m-0 lh-base"> {{ getNumberTranslate($refund_request->created_at->format('d-m-Y h:i:s A')) }} </p>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column  ">
                                        <div class="d-flex align-items-center flex-wrap gap_5">
                                    ...
                                    @if ($refund_request->shipping_method == "courier")
                                        <div class="summery_lists flex-fill">
                                            ...
                                            <div class="single_summery_list d-flex align-items-start gap_20">
                                                ...
                                                <p class="font_14 f_w_400 m-0">{{ getNumberTranslate(@$refund_request->pick_up_address_customer->phone) }}</p>
                                            </div>
                                            <div class="single_summery_list d-flex align-items-start gap_20">
                                            ...
                                            <div class="single_summery_list d-flex align-items-start gap_20">
                                                ...
                                                <p class="font_14 f_w_400 m-0">{{ getNumberTranslate(@$refund_request->pick_up_address_customer->postal_code) }}</p>
                                            </div>
                                        </div>
                                    @else
                                        <div class="summery_lists flex-fill">
