                        ...
                        <div class="tab-content tab_content" id="myTabContent">
                            @if($product->product->gallary_images->count())
                                ...
                                <div class="tab-pane fade {{$product->product->gallary_images->first()->id == $image->id?'show active':''}}"
                                    ...
                                    <img src="{{showImage($image->images_source)}}" alt="#"
                                        class="var_img_show" />
                                    </div>
                            ...
                            @else
                                <div class="tab-pane fade show active"
                                    ...
                                    <div class="product_img_div_for_modal">
                                    <img @if ($product->thum_img != null) src="{{showImage($product->thum_img)}}" @else src="{{showImage($product->product->thumbnail_image_source)}}" @endif alt="#"
                                        class="var_img_show" />
                                    </div>
                            ...
                            <div class="product_details_content">
                                ...
                                <ul>
                                    ...
                                    <li>{{__('common.tag')}} : <span>
                                        ...
                                        @if($key + 1 < $total_tag), @endif @endforeach </span>
                                    </li>
                                </ul>
                            </div>
                                ...
                                @if ($product->product->product_type == 2)
                                    <div class="single_details_content variant_image d-md-flex">
                                        ...
                                        <div class="img_div_width">
                                            ...
                                            <img src="{{showImage($sku->sku->variant_image)}}"
                                ...
                                <div class="product_details_btn row">
                                    <div id="add_to_cart_div" class="col-md-12 product_action_btn_list">
                                        @if ($product->stock_manage == 1 &&
                                        $product->skus->first()->product_stock >= $product->product->minimum_order_qty)
                                            <button type="button" id="add_to_cart_btn" class="btn_1 w-50">{{__('defaultTheme.add_to_cart')}}</button>
                                            <a href="#" class="btn_1 w-50 buy_now_btn" data-id="{{$product->id}}" data-type="product">{{__('common.buy_now')}}</a>
                                        ...
                                        <button type="button" disabled
                                            class="btn_1 w-100">{{__('defaultTheme.out_of_stock')}}</button>
                                        @endif
                                    </div>
                                    <div class="col-md-12 product_action_btn_list">
                                        <a class="btn_2 w-50 btn_2_padding add_to_wishlist_modal"
                                        id="wishlist_btn" data-product_id="{{$product->id}}"
                                        data-seller_id="{{$product->user_id}}">{{__('defaultTheme.add_to_wishlist')}}</a>
                                    <a class="btn_2 w-50 btn_2_padding" id="add_to_compare_btn"
