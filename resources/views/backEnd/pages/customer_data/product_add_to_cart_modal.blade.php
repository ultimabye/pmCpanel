                ...
                <div class="product_quick_view ">
                    ...
                    <div class="product_details_wrapper">
                        <div class="product_content_details mb_30">
                            ...
                            <h5 class="prise_text d-flex align-items-center gradient-color2">{{getProductDiscountedPrice($product)}}</h5>
                            ...
                            <div class="product_info">
                                ...
                                <div class="row mt_30" id="add_to_cart_div_modal">
                                    @if ($product->stock_manage == 1 && $product->skus->first()->product_stock >= $product->product->minimum_order_qty || $product->stock_manage == 0)
                                        ...
                                        <div class="col-md-6">
                                            <a href="#" class="fix-gr-bg primary-btn radius_5px text-center d-block py-2" data-id="{{$product->id}}" data-type="product">{{__('common.buy_now')}}</a>
                                        </div>
                                    @else
                                        <div class="col-md-6">
