...
@section('content')
    <div class="amazy_dashboard_area dashboard_bg py-0 d-none"> {{-- Multi vendor --}}
        <div class="container">
            <div class="row">
                {{-- <div class="col-xl-3 col-lg-4 pe-0">
                    @include('frontend.amazy.pages.profile.partials._menu')
                </div> --}}
                <div class="col-12 chat-px-mobile">
                   <div class="chat d-flex flex-wrap">
                        ...
                        <div class="chat-right">
                            <div class="order-wrap">
                                <h6 class="text-primary">Your  Last Order</h6>
                                <div>
    ...
    <div class="amazy_dashboard_area dashboard_bg section_spacing6"> {{-- Single vendor --}}
        <div class="container">
            <div class="row">
                <div class="col-xl-3 col-lg-4">
                    @include('frontend.amazy.pages.profile.partials._menu')
                </div>
                <div class="col-xl-9 col-lg-8 chat-px-mobile">
                    <div class="chat d-flex flex-wrap single_vendor">
                        <div class="chat-center" id="mobile_popup">
                            <div class="chat-close bg-primary text-white d-md-none">
                                <i class="ti-close"></i>
                            </div>
